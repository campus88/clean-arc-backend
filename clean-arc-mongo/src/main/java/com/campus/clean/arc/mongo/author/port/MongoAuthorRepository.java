...
import com.campus.clean.arc.mongo.author.port.queries.AuthorFiltersQuery;
...
@Repository
public class MongoAuthorRepository extends AbstractMongoRepository<String, AuthorEntity, AuthorDoc, AuthorFilters>
    ...
    @Override
    protected AbstractExampleQuery getSearchQuery(AuthorFilters authorFilters) {
        return new AuthorFiltersQuery(authorFilters);
    }
}
